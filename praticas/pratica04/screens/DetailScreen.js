import { View,Text,Image,Button,StyleSheet,TouchableOpacity, VirtualizedList, } from "react-native";
...
<Text style={styles.itemNome}>Nome do Produto</Text>
<Text style={styles.itemDescription}>Descrição detalhada do produto. 
Aqui vai um texto explicativo sobre o produto em questão.</Text>
...
appBar: { backgroundColor: "#6750A4", height: 64, 
paddingLeft: 16, paddingRight: 16, flexDirection: "row",
...
itemimage:{width:"100%",height:200,resizeMode:"cover",borderRadius:12,marginVertical:16,},

itemNome:{fontSize:24,fontWeight:"500",color:"#1C1B1F",marginBottom:8,},

itemDescription:{fontSize:16,color:"#49454F",marginBottom:16,},

priceContainer:{flexDirection:"row-reverse",justifyContent:"space-between",alignItems:"center",marginBottom:24,},

itemPrice:{fontSize:22,fontWeight:"500",color: "#6750A4",},

buttonContainer:{flexDirection:"row",alignItems:"center",},

button:{backgroundColor:"#E8DEF8",padding:12,borderRadius:100,marginHorizontal:8,},
